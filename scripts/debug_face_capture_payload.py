...
def debug_face_payload_generation():
    print("==========================================")
    print("   FaceCapture Payload Debugger")
    print("==========================================")
    ...
    # 2. 执行格式化逻辑 (Logic from FaceCapture.py send_to_agent)
