...
结束时间获取与上报：通过海康摄像头（仓库全景）监测人员是否离开。
...
服务器人脸识别接口：http://private-host:8088/system/visitorRecord/recognizeFace
人脸识别测试脚本：scripts\test_face_recognition.py
服务器Agent接口：（发送信息给Agent可以由Agent完成数据库写入）
        employee_id: str = "2007687214648188929",
        user_id: str = "235",
        base_url: str = "http://private-host:8088/system/employee/webhook/invoke",
