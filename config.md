...
接口：http://private-host:8088/system/visitorRecord/recognizeFace
...
(Note: Original password "REDACTED_PASSWORD" contains special character '@' which is URL-encoded to '%40')

## 其他环境配置说明
硬件：树莓派pi5，海康摄像头，RFID射频（串口），摄像头模块（串口）
