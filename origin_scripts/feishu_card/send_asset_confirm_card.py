...
RECEIVE_ID = "REDACTED_RECEIVE_ID" 
RECEIVE_ID_TYPE = "open_id"

# 卡片 JSON 文件路径
CARD_JSON_PATH = r"/home/lzwc/project/warehouse/origin_scripts/feishu_card/资产变动单（待确认）.json"
                ...
                for behavior in behaviors:
                    if behavior.get("type") == "callback" and "value" in behavior:
                        if isinstance(behavior["value"], dict):
                            ...
                            behavior["value"]["card_type"] = "asset_confirm"
